          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
            <div className="p-8 md:p-12">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-red-500 text-white rounded-lg font-medium hover:bg-red-700/50 focus:ring-2 focus:ring-red-500/50 transition-all duration-300 group"
              >
